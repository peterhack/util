...
# Install services
#git clone --branch release-0.3.0 https://github.com/keptn/jenkins-service.git --single-branch
#cd jenkins-service
#chmod +x deploy.sh
...
git clone --branch release-0.2.0 https://github.com/keptn/github-service.git --single-branch
cd github-service
chmod +x deploy.sh
./deploy.sh
...
git clone --branch release-0.1.1 https://github.com/keptn/servicenow-service.git --single-branch
...
git clone --branch release-0.1.2 https://github.com/keptn/pitometer-service.git --single-branch
